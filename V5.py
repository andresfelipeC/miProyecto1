            ...
            if i=="move;":
                ...
                if i[0][:7]=="ITERATE":
                    ...
                    for q in range(int(a)):
                        for p in i[1:]:
                            self.execute(p)
                if i[0][:3]=="IF " and i[0][len(i[0])-5:]==" THEN":
                    if i[0][3:len(i[0])-5]=="facing-north":
                        if self.facingnorth():
                            for b in i[1:]:
                                self.execute(b)
                        else: 
                            if ejecucion[m+1][0]=="ELSE":
                                for c in ejecucion[m+1][1:]:
                                    self.execute(c)
                    if i[0][3:len(i[0])-5]=="not-facing-north":
                        if not self.facingnorth():
                            ...
                            if ejecucion[m+1][0]=="ELSE":
                                for c in ejecucion[m+1][1:]:
                                    self.execute(c)
                    if i[0][3:len(i[0])-5]=="facing-south":
                        if self.facingsouth():
                            for b in i[1:]:
                                self.execute(b)
                        else: 
                            if ejecucion[m+1][0]=="ELSE":
                                for c in ejecucion[m+1][1:]:
                                    self.execute(c)
                    if i[0][3:len(i[0])-5]=="not-facing-south":
                        if not self.facingsouth():
                            ...
                            if ejecucion[m+1][0]=="ELSE":
                                for c in ejecucion[m+1][1:]:
                                    self.execute(c)
                    if i[0][3:len(i[0])-5]=="facing-west":
                        if self.facingwest():
                            for b in i[1:]:
                                self.execute(b)
                        else: 
                            if ejecucion[m+1][0]=="ELSE":
                                for c in ejecucion[m+1][1:]:
                                    self.execute(c)
                    if i[0][3:len(i[0])-5]=="not-facing-west":
                        if not self.facingwest():
                            ...
                            if ejecucion[m+1][0]=="ELSE":
                                for c in ejecucion[m+1][1:]:
                                    self.execute(c)
                    if i[0][3:len(i[0])-5]=="facing-east":
                        if self.facingeast():
                            for b in i[1:]:
                                self.execute(b)
                        else: 
                            if ejecucion[m+1][0]=="ELSE":
                                for c in ejecucion[m+1][1:]:
                                    self.execute(c)
                    if i[0][3:len(i[0])-5]=="not-facing-east":
